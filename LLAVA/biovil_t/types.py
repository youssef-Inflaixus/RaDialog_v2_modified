...
class ImageEncoderType(str, Enum):
    ...
    UNETPP_EFFICIENTNET = "unetpp_efficientnet"
    UNETPP_EFFICIENTNET_MULTI_IMAGE = "unetpp_efficientnet_multi_image"

    @classmethod
    def get_members(cls, multi_image_encoders_only: bool) -> List[ImageEncoderType]:
        if multi_image_encoders_only:
            return [cls.RESNET18_MULTI_IMAGE, cls.RESNET50_MULTI_IMAGE,cls.UNETPP_EFFICIENTNET_MULTI_IMAGE]
        else:
