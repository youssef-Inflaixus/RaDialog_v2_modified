...
from .unetpp_efficientnet import unetpp_efficientnet
...
class ImageEncoder(nn.Module):
    ...
    def _create_encoder(self, **kwargs: Any) -> nn.Module:
        ...
        elif self.img_encoder_type in [ImageEncoderType.UNETPP_EFFICIENTNET, ImageEncoderType.UNETPP_EFFICIENTNET_MULTI_IMAGE]:
            encoder_class = unetpp_efficientnet
        else:
...
class MultiImageEncoder(ImageEncoder):
    ...
    def forward(self,  # type: ignore[override]
        ...
        if previous_image is not None:
            ...
            # ✅ Upsample single image case too
            patch_x = F.interpolate(patch_x, size=(14, 14), mode='bilinear', align_corners=False)
